...
internal class DragLayout : FrameLayout, NestedScrollingParent3 {
    ...
    private inner class DragCallback : ViewDragHelper.Callback() {
        override fun tryCaptureView(child: View, pointerId: Int): Boolean {
            ...
            return when (mDragStyle) {
                DragStyle.None -> false
                DragStyle.Left -> !DragCompat.canViewScrollRight(mInnerScrollViews, mDownX, mDownY, false)
                DragStyle.Right -> !DragCompat.canViewScrollLeft(mInnerScrollViews, mDownX, mDownY, false)
                DragStyle.Top -> !DragCompat.canViewScrollDown(mInnerScrollViews, mDownX, mDownY, false)
                DragStyle.Bottom -> !DragCompat.canViewScrollUp(mInnerScrollViews, mDownX, mDownY, false)
            }
        }
